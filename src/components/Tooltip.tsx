...
export function Tooltip({ content, children, showIcon = false, position = 'top' }: TooltipProps) {
  ...
  return (
    <div className="relative inline-flex items-center">
      ...
      >
        {children || (
          showIcon && <HelpCircle className="w-4 h-4 text-gray-400 hover:text-gray-600" />
        )}
      </div>
