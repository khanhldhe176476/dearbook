  ...
  return (
    <div className="min-h-screen bg-[#FFF8F1] text-[#3E2A25] scroll-smooth">
      ...
      <div className={showAbout ? 'hidden' : ''}>
        ...
        <section id="ptb-box" className="py-10 md:py-14 relative overflow-hidden scroll-mt-24 bg-[#FFF8F1]">
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-white/90 backdrop-blur-sm rounded-full shadow-md mb-5 animate-fade-in">
              <Star className="w-3.5 h-3.5 text-yellow-500 fill-yellow-500" />
              <span className="text-xs font-medium text-[#5B4038]">Photobook box dành cho những món quà kỷ niệm</span>
            </div>

            <h1 className="text-4xl md:text-5xl font-bold mb-4 animate-fade-in" style={{ fontFamily: '"Cooper BT", "Cooper Black", Georgia, serif' }}>
              <span style={{ whiteSpace: 'nowrap' }}>Photobook Box</span>
              <br />
              <span
                style={{ fontFamily: '"Pinyon Script", "Great Vibes", cursive', color: '#B9423A', display: 'block', fontSize: 'clamp(2rem, 5vw, 3.5rem)', lineHeight: 1.1 }}
              >nhỏ xinh nhưng đầy cảm xúc</span>
            </h1>

            <p className="text-base text-[#7A5C53] mb-6 max-w-2xl mx-auto animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 animate-fade-in">
              ...
              <button onClick={() => handleNavClick('categories')} className="btn border border-[#B9423A] text-[#B9423A] bg-white hover:bg-[#F7D9CF] focus:outline-none">
          ...
          <div className="mt-10 grid md:grid-cols-3 gap-6">
            {photobookBoxItems.map((item, index) => (
              <div key={index} className="card p-6 text-center card-hover relative overflow-hidden">
                <div className="absolute -top-6 -right-6 text-6xl opacity-10">{item.emoji}</div>
                <div className="w-12 h-12 mx-auto bg-gradient-to-br from-[#D86F62] to-[#B9423A] rounded-xl flex items-center justify-center text-white mb-4 shadow-md">
                  {item.icon}
                </div>
                <div className="text-4xl mb-3">{item.emoji}</div>
                <h3 className="text-xl font-bold mb-2">{item.title}</h3>
                <p className="text-sm text-[#7A5C53] leading-relaxed">{item.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="categories" className="py-10 md:py-14 bg-[#FFFDF9] scroll-mt-24">
        <div className="container-custom">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-bold mb-3">
              Danh mục <span style={{ fontFamily: '"Pinyon Script", "Great Vibes", cursive', color: '#B9423A' }}>loại Photobook</span>
            </h2>
            <p className="text-base text-[#7A5C53] max-w-3xl mx-auto">
              ...
              <div key={category.id} className="card card-hover overflow-hidden group cursor-pointer">
                <div className="relative h-60 overflow-hidden">
                  ...
                  <div className="absolute top-3.5 right-3.5">
                    <span className="px-3 py-1.5 rounded-full bg-white text-[#B9423A] text-xs font-semibold shadow-md">
                      {category.badge}
                    </span>
                  </div>
                  <div className="absolute bottom-4 left-4 right-4 text-white">
                    <h3 className="text-xl font-bold mb-1.5">{category.title}</h3>
                    <p className="text-xs text-white/90">{category.description}</p>
                  </div>
                </div>

                <div className="p-4">
                  <button onClick={onGetStarted} className="w-full btn border border-[#B9423A] text-[#B9423A] bg-white hover:bg-[#B9423A] hover:text-white btn-sm">
                    Chọn loại này
                  </button>
                </div>
              </div>
      ...
      {/* Section 3: Themes */}
      <section id="themes" className="py-10 md:py-14 bg-[#F7D9CF] scroll-mt-24">
        <div className="container-custom">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-bold mb-3">
              Chọn <span style={{ fontFamily: '"Pinyon Script", "Great Vibes", cursive', color: '#B9423A' }}>chủ đề phù hợp</span>
            </h2>
            <p className="text-base text-[#7A5C53]">Mỗi chủ đề đều có cảm xúc, màu sắc và cách kể chuyện riêng</p>
          </div>
            ...
            {themes.map((theme) => (
              <div key={theme.id} className="card card-hover cursor-pointer overflow-hidden group">
                <div className="relative h-40 overflow-hidden">
                  ...
                  <div className="absolute top-3 left-3 text-3xl">{theme.icon}</div>
                </div>

                <div className="p-4">
                  <h3 className="text-lg font-bold mb-1.5">{theme.title}</h3>
                  <p className="text-[#7A5C53] text-xs leading-relaxed">{theme.description}</p>

                  <button onClick={onGetStarted} className="mt-3.5 w-full btn border border-[#B9423A] text-[#B9423A] bg-white hover:bg-[#B9423A] hover:text-white btn-sm">
                    Dùng chủ đề này
                  </button>
                </div>
              </div>
      ...
      {/* Features Section */}
      <section className="py-10 md:py-14 bg-[#FFFDF9]">
        <div className="container-custom">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Mọi thứ bạn cần để tạo
                <span style={{ fontFamily: '"Pinyon Script", "Great Vibes", cursive', color: '#B9423A', display: 'block', marginTop: '0.5rem', fontSize: 'clamp(1.75rem, 4.5vw, 3rem)', lineHeight: 1.15 }}>một photobook box hoàn chỉnh</span>
              </h2>
              ...
              <div className="grid sm:grid-cols-2 gap-3 mb-6">
                {features.map((feature, index) => (
                  <div key={index} className="flex items-start gap-2.5">
                    ...
                    <span className="text-sm text-[#5B4038]">{feature}</span>
                  </div>
                ))}
              </div>
      ...
      {/* Pricing Section */}
      <section className="py-10 md:py-14 bg-[#FFF8F1]">
        <div className="container-custom">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-bold mb-3">
              Chọn gói <span style={{ fontFamily: '"Pinyon Script", "Great Vibes", cursive', color: '#B9423A' }}>phù hợp với bạn</span>
            </h2>
            <p className="text-base text-[#7A5C53]">Giá tham khảo theo loại PTB</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {pricingPlans.map((plan) => (
              <div
                key={plan.name}
                className={`card p-6 relative card-hover ${plan.popular ? 'border-2 border-pink-400 shadow-2xl scale-[1.02]' : ''}`}
              >
                {plan.popular && (
                  <div className="absolute -top-3.5 left-1/2 -translate-x-1/2">
                    <span className="px-3.5 py-1.5 rounded-full bg-gradient-to-r from-pink-500 to-rose-500 text-white text-xs font-semibold shadow-md">
                      Phổ biến nhất
                    </span>
                  </div>
                )}
                ...
                <p className="text-sm text-[#7A5C53] mb-4">{plan.description}</p>

                <div className="mb-4">
                  <span className="text-4xl font-bold text-[#B9423A]">{plan.price}</span>
                  <span className="text-gray-500 text-sm ml-1.5">/ hộp</span>
                </div>

                <ul className="space-y-2 mb-6">
                  {plan.features.map((feature) => (
                    <li key={feature} className="flex items-start gap-2.5 text-sm text-[#5B4038]">
                ...
                <button
                  ...
                  className={`w-full btn ${plan.popular ? 'bg-[#B9423A] text-white hover:bg-[#96332E]' : 'border border-[#B9423A] text-[#B9423A] bg-white hover:bg-[#F7D9CF]'} btn-sm`}
                >
                  Chọn gói này
                </button>
              </div>
      ...
      <section className="py-10 md:py-14 bg-[#FFFDF9]">
        <div className="container-custom">
          <div className="text-center mb-10">
            <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-pink-100 text-[#B9423A] mb-4">
              <HelpCircle className="w-6 h-6" />
            </div>
            <h2 className="text-3xl md:text-4xl font-bold mb-3">
              Câu hỏi <span style={{ fontFamily: '"Pinyon Script", "Great Vibes", cursive', color: '#B9423A' }}>thường gặp</span>
            </h2>
            <p className="text-base text-[#7A5C53]">Một vài thông tin quan trọng trước khi bạn bắt đầu tạo Photobook</p>
          </div>

          <div className="max-w-3xl mx-auto space-y-3">
            {faqs.map((faq, index) => (
              <div key={index} className="card p-5">
                <h3 className="text-base font-bold mb-1.5">{faq.question}</h3>
                <p className="text-sm text-[#7A5C53] leading-relaxed">{faq.answer}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* CTA Section */}
      <section className="py-10 md:py-14 bg-[#B9423A] text-white">
        <div className="container-custom text-center">
          ...
          <button onClick={onGetStarted} className="btn bg-white text-[#B9423A] hover:bg-gray-50 shadow-lg">
            Tạo sách ngay
            <Sparkles className="w-5 h-5" />
          </button>
        </div>
